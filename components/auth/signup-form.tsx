...
export function LoginForm({
  ...
  const handleGithubSignIn = async () => {
    ...
    try {
      window.location.href = "https://ep-backend-fzs9.onrender.com/api/v1/auth/oauth/github";
    } catch (error) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      window.location.href = "https://ep-backend-fzs9.onrender.com/api/v1/auth/oauth/google";
    } catch (error) {
